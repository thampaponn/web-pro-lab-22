...
router.get("/blogs/:id", function (req, res, next) {
  ...
  const promise2 = pool.query("SELECT * FROM comments left outer join images on comments.id = images.comment_id WHERE comments.blog_id=? order by comment_date", [req.params.id]);
